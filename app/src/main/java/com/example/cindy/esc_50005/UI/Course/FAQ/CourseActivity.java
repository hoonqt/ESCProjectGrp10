...
//
        final com.example.cindy.esc_50005.UI.Course.FAQ.CoursePagerAdapter pagerAdapter=new com.example.cindy.esc_50005.UI.Course.FAQ.CoursePagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
