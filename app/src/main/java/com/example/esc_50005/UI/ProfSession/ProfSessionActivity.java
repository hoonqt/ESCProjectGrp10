...
public class ProfSessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final com.example.esc_50005.UI.ProfSession.ProfSessionAdapter pagerAdapter=new com.example.esc_50005.UI.ProfSession.ProfSessionAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
